...
<form method="post" enctype="multipart/form-data" action="<?= route('admin-orders-create', []); ?>">
...
<hr>
    <div class="mb-3">
        ...
        <input type="number" value="{{ old('product_id') }}" name="product_id" class="form-control" id="item1" required>
        <div class="form-text">product_id</div>
    </div>

    <div class="mb-3">
        <label for="item1" class="form-label">partner_id</label>
        <input type="number" value="{{ old('partner_id') }}" name="partner_id" class="form-control" id="item1">
        <div class="form-text">partner_id</div>
    </div>

    <div class="mb-3">
        <label for="item1" class="form-label">amount</label>
        <input type="text" value="{{ old('amount') }}" name="amount" class="form-control" id="item1" required>
        <div class="form-text">Полная стоимость с наценкой</div>
    </div>

    <div class="mb-3">
        <label for="item1" class="form-label">margin</label>
        <input type="text" value="{{ old('margin') }}" name="margin" class="form-control" id="item1" required>
        <div class="form-text">наценка</div>
    </div>

    <div class="mb-3">
        <label for="item1" class="form-label">partner_bid</label>
        <input type="text" value="{{ old('partner_bid') }}" name="partner_bid" class="form-control" id="item1">
