            ...
            <div class="col-lg-2 col-md-4 col-sm-6 col-xs-6">
                <div class="widget-products__item">
                    ...
                    <div class="widget-products__wrap">
                        <div class="widget-products__item-title <?= $style === "orange" ? "bg-orange" : ""; ?>" >
                            <span>{{$item->short_title}}</span>
                        </div>

                        <div class="widget-products__content">
                            @if($item->hasImages())
                            <img src='<?= asset("images/products/$item->id/middle/{$item->imageFirst()->alias}"); ?>' alt="Новый продукт: фото <?= $item->short_title; ?>" >
                            @else
